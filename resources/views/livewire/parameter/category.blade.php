<div>
    ...
    <div class="relative overflow-x-auto sm:rounded-lg">
        ...
        <div class="flex items-center justify-between pb-4 bg-white dark:bg-gray-900">
            ...
            {{-- <div>
                <button wire:click="addNewCategory()" type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Tambah Kategori</button>
            </div> --}}
        </div>
        {{-- new Category form --}}
        @if ($addNewCategory == true)
            <div
                class="w-full p-4 mb-3 bg-white border border-gray-200 rounded-lg shadow sm:p-4 dark:bg-gray-800 dark:border-gray-700">
                <h5 class="mb-2 text-xl font-bold border-b text-gray-900 dark:text-white">Tambah Ruangan</h5>
                <div class="px-3 mx-3">
                    <form wire:submit.prevent="store">
                        <label for="category-name"
                            class="block mb-2 text-sm font-medium text-gray-600 dark:text-white">Nama Ruangan</label>
                        <input wire:model="newCategoryName" type="text" id="category-name"
                        ...
                        <button wire:click="cancelNewCategory" type="button"
                    ...
                    @if ($categoryId == $item->id)
                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                            ...
                            <td class="px-6 py-4 text-center">
                                <a wire:click="update()" href="#"
                                    class="bg-green-500 text-white rounded p-2">Simpan</a>
                                <a wire:click="cancelEdit()" href="#"
                                    class="bg-red-500 text-white rounded p-2">Batal</a>
                            </td>
                        </tr>
                    @else
                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
