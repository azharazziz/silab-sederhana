                    ...
                    @foreach($resultInputs as $key => $value)
                        <div class="flex items-center mb-2">   
                            ...
                            <div class="relative w-full">
                                ...
                                <input wire:model="resultOption.{{ $value }}.option" type="text" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Opsi {{ $key + 1 }}">
                            </div>
            ...
            <tbody>
                ...
                {{-- edit --}}
                    ...
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                        <td class="px-6 py-2 w-full" colspan="6">
                            <div class="my-3">
