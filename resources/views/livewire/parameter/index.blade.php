<div>
        ...
        <div class="flex items-center justify-between pb-4 bg-white dark:bg-gray-900">
            <div class="flex space-x-2">
                <div>
                    ...
                    <div>
                        <select wire:model="searchCategory" id="countries"
            ...
            <div>
                <button wire:click="addNewParameter()" type="button"
    ...
    @if ($addNewParameter == true)
        ...
        <div
            class="w-full p-4 mb-3 bg-white border-x border-b border-gray-200 rounded-x-lg rounded-b-lg sm:p-4 dark:bg-gray-800 dark:border-gray-700">
            <div class="px-3 mx-3">
                <form wire:submit.prevent="store">
                    <div class="mb-6">
                        <label for="parameter-name"
                            class="block mb-2 text-sm font-medium text-gray-600 dark:text-white">Nama Parameter</label>
                        <input wire:model="newParameterName" type="text" id="parameter-name"
                    ...
                    <div class="mb-6">
                        ...
                        <select wire:model="newCategoryId" id="category"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                    ...
                    <div class="mb-6">
                        <label for="unit" class="block mb-2 text-sm font-medium text-gray-600 dark:text-white">Unit
                            Parameter</label>
                        <input wire:model="newUnit" type="text" id="unit"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                    </div>
                    <div class="mb-6">
                        <label for="result-method"
                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Opsi Hasil</label>
                        <select wire:model='resultMethod' id="result-method"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                    ...
                    @if ($resultMethod == 'option')
                        <div class="mb-6">
                            <label for="x"
                                class="block mb-2 text-sm font-medium text-gray-600 dark:text-white">Opsi</label>
                            @foreach ($resultInputs as $key => $value)
                                <div class="flex items-center mb-2">
                                    ...
                                    <div class="relative w-full">
                                        ...
                                        <input wire:model="resultOption.{{ $value }}.option" type="text"
                                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                            placeholder="Opsi {{ $key + 1 }}">
                                    </div>
                                    <button type="button" wire:click="removeOption({{ $key }})"
                                ...
                                @enderror
                            @endforeach
                            <button wire:click="addOption( {{ $i }} )" type="button"
                                class="block w-full text-gray-900 bg-white border-2 border-dashed border-gray-300 focus:outline-none hover:bg-gray-100  font-medium rounded-lg text-sm px-5 py-2.5 my-2 dark:bg-gray-800 dark:text-white dark:border-gray-600 dark:hover:bg-gray-700 dark:hover:border-gray-600 ">Tambah
                                Opsi</button>
                        </div>
                    @endif
                    <div class="mb-6">
                        <label for="reference-value"
                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nilai Rujukan</label>
                        <textarea wire:model="newReferenceValue" id="message" rows="4"
                            class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                            placeholder="Masukkan nilai rujukan"></textarea>
                    </div>
                    <div class="mb-6">
                        <label for="price"
                            class="block mb-2 text-sm font-medium text-gray-600 dark:text-white">Biaya</label>
                        <input wire:model="newPrice" type="text" id="price"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        @error('newPrice')
                            <p class="mt-2 text-sm text-red-600 dark:text-red-500"><span class="font-medium">Oops!</span>
                                {{ $message }}</p>
                    ...
                    <div class="mb-6">
                        <label for="top"
                            class="block mb-2 text-sm font-medium text-gray-600 dark:text-white">Batas Atas</label>
                        <input wire:model="newTop" type="text" id="top"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        @error('newTop')
                            <p class="mt-2 text-sm text-red-600 dark:text-red-500"><span
                                    class="font-medium">Oops!</span> {{ $message }}</p>
                    ...
                    <div class="mb-6">
                        <label for="bottom"
                            class="block mb-2 text-sm font-medium text-gray-600 dark:text-white">Batas Bawah</label>
                        <input wire:model="newBottom" type="text" id="bottom"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        @error('newBottom')
                            <p class="mt-2 text-sm text-red-600 dark:text-red-500"><span
                                    class="font-medium">Oops!</span> {{ $message }}</p>
                    ...
                    <button wire:click="cancelNewParameter" type="button"
                            ...
                            <td class="px-6 py-2 w-full" colspan="7">
                                <div class="my-3">
                                    <form wire:submit.prevent="update">
                                        <div class="mb-6">
                                            <label for="parameter-name"
                                                class="block mb-2 text-sm font-medium text-gray-600 dark:text-white">Nama
                                                Parameter</label>
                                            <input wire:model="newParameterName" type="text" id="parameter-name"
                                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                            @error('newParameterName')
                                        ...
                                        <div class="mb-6">
                                            <label for="unit"
                                                class="block mb-2 text-sm font-medium text-gray-600 dark:text-white">Unit
                                                Parameter</label>
                                            <input wire:model="newUnit" type="text" id="unit"
                                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                        </div>
                                                ...
                                                @foreach ($resultInputs as $key => $value)
                                                    <div class="flex items-center mb-2">
                                                        ...
                                                        <div class="relative w-full">
                                                            ...
                                                            <input
                                                                wire:model="resultOption.{{ $value }}.option"
                                                                type="text"
                                                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                                                placeholder="Opsi {{ $key + 1 }}">
                                                        </div>
                                                        <button type="button"
                                                            wire:click="removeOption({{ $key }})"
                                                            class="p-2.5 ml-2 text-sm font-medium text-white bg-red-700 rounded-lg border border-red-700 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-800">
